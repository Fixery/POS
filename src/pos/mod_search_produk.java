...
/*
 * mod_search_produk.java
 *
 * Created on Mar 18, 2015, 4:08:34 AM
 */
 ...
 * @author User
 */
public class mod_search_produk extends javax.swing.JDialog {
Connection con = null;
Statement sta = null;
String data[]=new String[5];
    /** Creates new form mod_search_produk */
    public mod_search_produk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try{
        ...
        Tabel(tb_barang,new int[]{225,125,80,125,75});
        setDefaultTable();
    }
     ...
     private javax.swing.table.DefaultTableModel getdeDefaultTableModel(){
        return new javax.swing.table.DefaultTableModel(
                new Object [][]{},
                new String []{"Produk","Harga Beli","Stock","Tanggal Masuk","Toko"}){
       ...
       //cariBy();
        try{
            ...
            while(res.next()){
                ...
                data[1]=res.getString("harga_produk");
                data[2]=res.getString("stock");
                data[3]=res.getString("tgl_masuk");
                data[4]=res.getString("Toko");
...
void cari(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            mod_pembelian.txt_nama.setText(tb_barang.getValueAt(baris, 0).toString());
            mod_pembelian.txt_harga_beli.setText(tb_barang.getValueAt(baris, 1).toString());
            mod_pembelian.txt_toko.setText(tb_barang.getValueAt(baris, 4).toString());
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mod_search_produk dialog = new mod_search_produk(new javax.swing.JFrame(), true);
